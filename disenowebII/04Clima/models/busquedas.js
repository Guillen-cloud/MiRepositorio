...
class Busquedas {
    ...
    get paramsMapbox() {
        return {
            'access_token': process.env.MAPBOX_KEY || 'pk.eyJ1IjoicmljYXJkb2diIiwiYSI6ImNtNDM0Y2p1eTA4MG4yaXB4dmx2bTFnM3cifQ.-YR3JaIxI4f8lvEQ62zQbQ',  // Tu clave MapBox aquí
            'limit': 10, 
            'language': 'es'
        };
    }
    ...
    get paramsWeather() {
        return {
            appid: 'b8d835a95e3432d4242ca923bd6195e1',  // Tu clave OpenWeather aquí
            units: 'metric', 
            lang: 'es'
        };
    }
